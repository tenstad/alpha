...
impl Translator {
    pub fn translate(node: &ast::Node) {
        match node {
            ...
            ast::Node::FnDef(name, params, body) => Self::translate_fn(name, params, body),
            _ => todo!(),
        }
    }

    fn translate_fn(name: &Option<String>, params: &Vec<String>, body: &Box<ast::Node>) {
